...
SIGNAL \add_instance|q1~3_combout\ : std_logic;
...
-- Equation(s):
-- \add_instance|Equal0~0_combout\ = (\input_vector~combout\(3) & (\input_vector~combout\(0) & (\input_vector~combout\(2) & !\input_vector~combout\(4))))
...
-- Equation(s):
-- \add_instance|Equal0~1_combout\ = ((\add_instance|Equal0~0_combout\ & (\input_vector~combout\(1))))
...
-- Equation(s):
-- \add_instance|Equal2~0_combout\ = (\input_vector~combout\(1) & (((!\input_vector~combout\(0)))))
...
-- Equation(s):
-- \add_instance|Equal2~1_combout\ = (!\input_vector~combout\(3) & (!\input_vector~combout\(4) & (!\input_vector~combout\(2) & \add_instance|Equal2~0_combout\)))
...
PORT MAP (
	...
	datac => \input_vector~combout\(2),
	datad => \add_instance|Equal2~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \add_instance|q0~0_combout\ = ((\add_instance|Equal0~0_combout\ & (!\input_vector~combout\(1))))
...
\add_instance|q1~3\ : maxv_lcell
-- Equation(s):
-- \add_instance|q1~3_combout\ = (\input_vector~combout\(5) & (((\add_instance|q1~regout\)))) # (!\input_vector~combout\(5) & (\add_instance|Equal0~0_combout\ & (\input_vector~combout\(1) & !\add_instance|q1~regout\)))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \add_instance|q1~3_combout\);

-- Location: LC_X12_Y1_N2
\add_instance|q1\ : maxv_lcell
-- Equation(s):
-- \add_instance|q1~regout\ = DFFEAS((\add_instance|q1~regout\ & (!\add_instance|q1~3_combout\ & ((!\add_instance|q0~regout\) # (!\add_instance|Equal2~1_combout\)))) # (!\add_instance|q1~regout\ & (((\add_instance|q0~regout\ & 
-- \add_instance|q1~3_combout\)))), GLOBAL(\input_vector~combout\(6)), VCC, , , , , , )
...
PORT MAP (
	...
	datad => \add_instance|q1~3_combout\,
	aclr => GND,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \add_instance|q0~1_combout\ = (\add_instance|q0~regout\ & (((\add_instance|q1~regout\)))) # (!\add_instance|q0~regout\ & ((\add_instance|q1~regout\ & ((\add_instance|q0~0_combout\))) # (!\add_instance|q1~regout\ & (\add_instance|Equal2~1_combout\))))
...
-- Equation(s):
-- \add_instance|q0~regout\ = DFFEAS((!\input_vector~combout\(5) & ((\add_instance|q0~1_combout\) # ((!\add_instance|Equal0~1_combout\ & \add_instance|q0~regout\)))), GLOBAL(\input_vector~combout\(6)), VCC, , , , , , )
...
PORT MAP (
	clk => \input_vector~combout\(6),
	dataa => \input_vector~combout\(5),
	datab => \add_instance|Equal0~1_combout\,
	datac => \add_instance|q0~regout\,
...
-- Equation(s):
-- \add_instance|Mux2~0_combout\ = (\add_instance|q0~regout\ & (((\add_instance|Equal2~1_combout\ & \add_instance|q1~regout\))))
...
PORT MAP (
	...
	datac => \add_instance|Equal2~1_combout\,
	datad => \add_instance|q1~regout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|Mux2~0_combout\,
	oe => VCC,
